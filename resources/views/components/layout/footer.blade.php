    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Rewards
                                    Program</a>
                            </li>
                            <li>
                    ...
                    <div class="mt-10 md:mt-0">
                        <h3 class="text-sm font-semibold leading-6 text-white">Hours</h3>
                        <ul role="list" class="mt-6 space-y-4">
                            <li>
                                <p class="text-sm leading-6 text-gray-300">Sun: 10am
                                    - 6pm</p>
                            </li>
                            <li>
                                <p class="text-sm leading-6 text-gray-300">Mon -
                                    Sat: 9am - 8pm</p>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="mt-10 xl:mt-0">
                ...
                <p class="mt-2 text-sm leading-6 text-gray-300">Be the first to know about deals and events.</p>
        ...
        <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
            <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2023 Red Barn Liquor & Beverage
                Market.</p>
        </div>
    </div>
</footer>
